...
from engine.hifi_gan.utils import get_padding, init_weights
...
class Generator(torch.nn.Module):
  def __init__(self, h):
    ...
    for i, (u, k) in enumerate(zip(h.upsample_rates, h.upsample_kernel_sizes)):
      self.ups.append(
          weight_norm(ConvTranspose1d(h.upsample_initial_channel // (2**i), h.upsample_initial_channel // (2**(i + 1)), k, u, padding=(k - u) // 2)))
